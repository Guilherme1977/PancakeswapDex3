...
import iccAbi from 'config/abi/icc.json'
...
export const getCakeContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(iccAbi, tokens.cake.address, signer)
}
...
export const getIccVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(iccVaultAbi, getIccVaultAddress(), signer)
}
