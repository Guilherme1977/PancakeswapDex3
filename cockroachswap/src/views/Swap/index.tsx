...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const ICC = useCurrency("0x8d672014fb107cb409dccd9042dda3b97313f4c3")
  ...
  // if (!currencies[Field.OUTPUT]) currencies[Field.OUTPUT] = ICC
  // console.log(ICC);
  ...
  useEffect(() => {
    // const ICC = useCurrency("0x8d672014fb107cb409dccd9042dda3b97313f4c3");
    if (!currencies.OUTPUT)  handleOutputSelect(ICC);

  }, [handleOutputSelect, currencies, ICC])
    ...
    <div className="exchange-card-wrapper" >
      <Page>
        <AppBody>
          ...
          <Wrapper id="swap-page" className="exchange-card">
            <AutoColumn gap="md">
              <CurrencyInputPanel
            ...
            <Box mt="1rem">
              {swapIsUnsupported ? (
                ...
                <ConnectWalletButton width="100%" className="btn-theme-two btn-lg" />
              ) : showWrap ? (
