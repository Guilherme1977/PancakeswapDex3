...
var ICockroachPair = _interopDefault(require('@pancakeswap-libs/pancake-swap-core/build/ICockroachPair.json'));
...
var FACTORY_ADDRESS = '0xF6150F721d95218918C4f3b62E4229d12fffF648';
var INIT_CODE_HASH = '0x3f7ddf7c66a3e6b87be5710470b74b79618f6b8c7b34a996d4fdd1256b59cacd';
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'ICC-LP', 'Intergalactic Cockroach LPs');
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, ICockroachPair.abi, provider).getReserves()).then(function (_ref) {
